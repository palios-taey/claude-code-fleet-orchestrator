...
OPTIONAL_ENV = (
    ...
    ("ORCH_AUDIT_CAPABILITY_PRIVATE_KEY_PATH", "ORCH_DATA_DIR/audit-capability/ed25519.private",
     "Ed25519 private key for orch-audit-capabilityd issuer only (mode 0600); API must not load it"),
    ...
    ("ORCH_AUDIT_CAPABILITY_SOCKET", "ORCH_DATA_DIR/audit-capability/issuer.sock",
     "unix socket path for the principal-separated audit capability issuer daemon"),
    ("ORCH_SESSION_ID", "unset",
     "fleet session identity in process environ; issuer reads peer /proc/pid/environ via SO_PEERCRED"),
