...
This project is indexed by GitNexus as **claude-code-fleet-orchestrator** (11029 symbols, 21161 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/claude-code-fleet-orchestrator/context` | Codebase overview, check index freshness |
| `gitnexus://repo/claude-code-fleet-orchestrator/clusters` | All functional areas |
| `gitnexus://repo/claude-code-fleet-orchestrator/processes` | All execution flows |
| `gitnexus://repo/claude-code-fleet-orchestrator/process/{name}` | Step-by-step execution trace |
