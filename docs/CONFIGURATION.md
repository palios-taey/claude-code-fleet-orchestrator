...
| `ORCH_OUTWARD_HANDLE` | unset | Revocable possession handle minted at `bind_current_task` and deleted on unbind. Worker GitHub clients present this handle; a claimed session name cannot substitute for it. |
