...
| fleet_orchestrator/context_assembler.py | 381 | _safe_context_record | harmless-best-effort | Optional ref-context retrieval emits an unavailable marker instead of failing packet assembly. | Annotated in registry; no behavior change. |
| fleet_orchestrator/context_assembler.py | 628 | _ledger_tail | harmless-best-effort | Ledger tail is diagnostic context; failure is returned as unavailable metadata. | Annotated in registry; no behavior change. |
| fleet_orchestrator/context_assembler.py | 912 | _git_head | harmless-best-effort | Git hash is packet metadata; failure falls back to unknown. | Annotated in registry; no behavior change. |
