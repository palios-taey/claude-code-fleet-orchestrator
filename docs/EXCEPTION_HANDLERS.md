...
| fleet_orchestrator/tasks_api.py | 1161 | session_wake_packet | intentional-fail-closed | Wake-packet assembly errors return ok:false to the caller. | Annotated in registry; no behavior change. |
| fleet_orchestrator/tasks_api.py | 1182 | health | intentional-fail-closed | Health probe reports 503 when ready-task lookup fails. | Annotated in registry; no behavior change. |
